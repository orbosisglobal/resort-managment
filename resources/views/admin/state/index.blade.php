            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">States List</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content rounded">
                ...
                <div class="modal-body px-10 px-lg-15 pt-0 pb-15">
                    <!--begin:Form-->
                    <form id="create_state_form" class="form" action="#">
                        <!--begin::Heading-->
                        @method('POST')
                        ...
                        <div class="d-flex flex-column mb-8 fv-row">
                            ...
                            <!--end::Label-->
                            <input type="text" class="form-control form-control-solid" placeholder="Enter State Name"
                                name="name" id="name" />
                        </div>
                        <!--end::Input group-->
                        <!--begin::Input group-->
...
@push('scripts')
    <script>
        ...
        if (window.innerWidth < 890) {
            ...
            $("#create_state_form").submit(function(e) {
                e.preventDefault();
                ...
                if (id !== '') {
                    ...
                    url = "{{ route('state.update', ':id') }}".replace(':id', id);
                } else {
