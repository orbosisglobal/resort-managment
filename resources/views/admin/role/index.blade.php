        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content rounded">
                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    <!--begin:Form-->
                    <form id="create_role_form" class="form" action="#">
                        <!--begin::Heading-->
                        @method('POST')
                        ...
                        <div class="d-flex flex-column mb-8 fv-row">
                            ...
                            <!--end::Label-->
                            <input type="text" class="form-control form-control-solid" placeholder="Enter Role Name"
                                name="name" id="name" />
                        </div>
                        <!--end::Input group-->
                        <!--begin::Input group-->
