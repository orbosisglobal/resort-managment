            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">Cities List</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content rounded">
                ...
                <div class="modal-body  px-10 px-lg-15 pt-0 pb-15">
                    <!--begin:Form-->
                    <form id="create_city_form" class="form" action="#">
                        <!--begin::Heading-->
                        @method('POST')
                        ...
                        <div class="d-flex flex-column mb-8 fv-row">
                            ...
                            <!--end::Label-->
                            <select class="form-select mb-2" data-control="select2" data-hide-search="true" id="state_id"
                                name="state_id" data-placeholder="Select an option">
...
@push('scripts')
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#state_id').select2({
                dropdownParent: $('#create_city_form')
            });
        ...
        if (window.innerWidth < 890) {
            ...
            $("#create_city_form").submit(function(e) {
                ...
                if (id !== '') {
                    ...
                    url = "{{ route('city.update', ':id') }}".replace(':id', id);
                } else {
                ...
                $.ajax({
                    ...
                    url: url,
                    //url: "{{ isset($data) ? route('city.update', $data->id) : route('city.store') }}",
                    data: formData,
                    processData: false,
                    contentType: false,
                    headers: {
